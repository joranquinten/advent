    ...
    function getAllItems() {
      ...
      var dates = [
        ...
        },
        {
          ...
          emoji: "🐒",
          details:
            "<p>We gaan lekker naar de  Beste dierentuin met zijn viertjes. Broodjes worden gesmeerd (door twee Beren), pakjes drinken mee. Koekjes, snoepjes en de wandelwagen.<br/>Lekker een dagje op avontuur!</p>",
          links: [
            {
        ...
        },
        {
          ...
          emoji: "🌌",
          details:
            "<p>De Perse&iuml;den bereiken op <strong>maandag 13 augustus</strong> hun hoogtepunt. Dus op dinsdag 14 augustus, als het niet bewolkt is, gaan we met een paar kleedjes, fles wijn en lantaarns op Bedaf sterren kijken.</p>",
          links: [
            {
              link:
